      ...
      <div className='grid grid-cols-1 md:grid-cols-2'>
        ...
        <div className='pt-20 px-10 md:pl-10 lg:pl-16'>
          ...
          <div className='text-searchLogo font-quicksand mt-8'>
            ...
            <span className='text-btn ml-4 cursor-pointer' onClick={() => navigate('/login')}>
              Log in
            </span>
          </div>
          ...
          <form onSubmit={handleSignUp}>
            <div className='grid grid-cols-2'>
              <div className=''>
                <div className='font-quicksand text-pup mt-10 mb-1'>First Name</div>
              ...
              <div className=''>
                <div className='font-quicksand text-pup mt-10 mb-1'>Last Name</div>
                <div className=' flex items-center bg-search w-[90%]'>
                  <input
                    className='bg-transparent search text-searchLabel h-10 py-1 px-2  text-[0.8rem] outline-none w-full placeholder:tracking-wider placeholder:text-[0.8rem] placeholder:font-quicksand'
                    type='text'
              ...
              <div className=''>
                <div className='font-quicksand text-pup mt-8 mb-1'>Your Email</div>
                <div className=' flex items-center bg-search w-[90%]'>
                  <input
                    className='bg-transparent search text-searchLabel h-10 py-1 px-2  text-[0.8rem] outline-none w-full placeholder:tracking-wider placeholder:text-[0.8rem] placeholder:font-quicksand'
                    type='email'
              ...
              <div className=''>
                <div className='font-quicksand text-pup mt-8 mb-1'>Password</div>
                <div className=' flex bg-search items-center search w-[90%]'>
                  <input
                    ...
                    required></input>
                  {lock ? (
                    <HiLockClosed class='text-xl mx-3 cursor-pointer text-searchLogo' onClick={() => setLock(!lock)} />
                  ) : (
                    <HiLockOpen class='text-xl mx-3 cursor-pointer text-searchLogo' onClick={() => setLock(!lock)} />
                  )}
                </div>
              </div>
            </div>
            ...
            <div className='flex flex-col items-center w-max relative'>
              <button
                ...
                disabled={load}
                class={`${
                  load ? 'py-3 items-center flex justify-center cursor-not-allowed' : ''
              ...
              <div className='mt-7 font-quicksand text-searchLogo text-base'>OR</div>
            </div>
          </form>
          <div className='mt-7 flex items-center font-quicksand text-searchLogo'>
            You can connect with
            <img
              src='https://raw.githubusercontent.com/meet2424/ad-inventory/master/src/Images/twitter-auth.png?token=GHSAT0AAAAAAB4CHSSDJFPHTS4NF7YZLW7OZBG46HQ'
              alt=''
              className='h-8 w-8 ml-3 cursor-pointer'
            />
            <img
              src='https://raw.githubusercontent.com/meet2424/ad-inventory/master/src/Images/google-auth.png?token=GHSAT0AAAAAAB4CHSSCJ642LJYPGWHF4ELGZBG47FQ'
              alt=''
              className='h-8 w-8 ml-3 cursor-pointer'
            />
            <img
              src='https://raw.githubusercontent.com/meet2424/ad-inventory/master/src/Images/fb-auth.png?token=GHSAT0AAAAAAB4CHSSCSYBZHBKNMBPSAGX4ZBG472A'
              alt=''
              className='h-8 w-8 ml-3 cursor-pointer'
            />
          </div>
