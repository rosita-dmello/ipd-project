      ...
      <div className='grid grid-cols-1 md:grid-cols-2'>
        ...
        <div className='pt-20 px-10 md:pl-10 lg:pl-16'>
          ...
          <div className='text-searchLogo font-quicksand mt-8'>
            Become a part of company name?{' '}
            <span className='text-btn ml-4 cursor-pointer' onClick={() => navigate('/signup')}>
              Create an account
            </span>
          </div>
          ...
          <form onSubmit={handleSignIn}>
            ...
            <div className='flex flex-col items-center w-max relative'>
              <button
                ...
                disabled={load}
                class={`${
                  load ? 'flex items-center py-3 h-12 w-44 justify-center cursor-not-allowed' : 'py-2 h-12 w-32'
